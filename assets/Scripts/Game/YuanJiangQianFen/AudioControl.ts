...
export class AudioControl extends Component {
    ...
    start() {
        ...
        ResourceLoader.Instance.loadAsset("YuanJiangQianFenAudio", "bg", AudioClip, (clip: AudioClip) => {
    ...
    public playStart() {
        ...
        ResourceLoader.Instance.loadAsset("YuanJiangQianFenAudio", "gamestart", AudioClip, (clip: AudioClip) => {
            if (clip) {
    ...
    // 播放发牌声音
    private playDeal() {
        ResourceLoader.Instance.loadAsset("YuanJiangQianFenAudio", "dealcard", AudioClip, (clip: AudioClip) => {
            if (clip) {
                this.loopSource.stop();
    ...
    public playGenre(male: boolean, clientSeat: number, genre: number, card: any, firstPlay: boolean) {
        ...
        ResourceLoader.Instance.loadAsset("YuanJiangQianFenAudio", clipName, AudioClip, (clip: AudioClip) => {
            if (clip) {
    ...
    // 播放叫分声音
    public playCallScore(seat: number) {
        if (GameManager.Instance.SoundMute) return;
        if (!this.gameSources[seat]) return;
        ResourceLoader.Instance.loadAsset("YuanJiangQianFenAudio", "callscore", AudioClip, (clip: AudioClip) => {
            if (clip) {
                this.gameSources[seat].stop();
                this.gameSources[seat].clip = clip;
                this.gameSources[seat].play();
            }
        });
    }
    ...
    public playAlert() {
        ...
        ResourceLoader.Instance.loadAsset("YuanJiangQianFenAudio", "warning", AudioClip, (clip: AudioClip) => {
            if (clip) {
                this.shareSource.stop();
                this.shareSource.clip = clip;
                this.shareSource.play();
