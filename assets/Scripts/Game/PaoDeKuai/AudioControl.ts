...
export class AudioControl extends Component {
    ...
    start() {
        ...
        ResourceLoader.Instance.loadAsset("PaoDeKuaiAudio", "bg", AudioClip, (clip: AudioClip) => {
    ...
    public playStart() {
        ...
        ResourceLoader.Instance.loadAsset("PaoDeKuaiAudio", "gamestart", AudioClip, (clip: AudioClip) => {
            if (clip) {
    ...
    // 播放发牌声音
    private playDeal() {
        ResourceLoader.Instance.loadAsset("PaoDeKuaiAudio", "dealcard", AudioClip, (clip: AudioClip) => {
            if (clip) {
                this.loopSource.stop();
    ...
    public playGenre(male: boolean, clientSeat: number, genre: number, card: any, firstPlay: boolean) {
        ...
        ResourceLoader.Instance.loadAsset("PaoDeKuaiAudio", clipName, AudioClip, (clip: AudioClip) => {
            if (clip) {
    ...
    public playAlert() {
        ...
        ResourceLoader.Instance.loadAsset("PaoDeKuaiAudio", "warning", AudioClip, (clip: AudioClip) => {
            if (clip) {
                this.shareSource.stop();
                this.shareSource.clip = clip;
                this.shareSource.play();
