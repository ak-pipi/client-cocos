...
@ccclass('HongZhongMahjongPlayer')
export class HongZhongMahjongPlayer extends Component {
    @property({ type: Node })
    ...
    @property({ type: Label })
    private leftTileNum: Label = null;
    ...
    public clear() {
        ...
        if (this.leftTileNum) this.leftTileNum.string = null;
    ...
    public setLeftTileNum(num: number) {
        if (!this.leftTileNum) return;
        this.leftTileNum.string = "剩" + num.toString() + "张";
    }
