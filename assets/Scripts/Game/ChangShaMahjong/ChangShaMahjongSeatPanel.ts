...
@ccclass('ChangShaMahjongSeatPanel')
export class ChangShaMahjongSeatPanel extends Component {
    ...
    public setData(seat: number, room: ChangShaMahjongRoom): void {
        this.seat = seat;
        this.room = room;
    }
    ...
    public setPlayerInfo(playerInfo: any, isSelf: boolean, isOwner: boolean): void {
    ...
    public setOwnerSeat(setting: boolean): void {
